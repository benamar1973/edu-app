...
# التنسيقات (تشمل إخفاء الإشهار والشريط السفلي للمنصة)
st.markdown(f"""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Tajawal:wght@400;700&display=swap');
    * {{ font-family: 'Tajawal', sans-serif; }}
    
    /* إخفاء الهيدر والفوتر وشريط المنصة السفلي (الإشهار) */
    header, footer, .st-emotion-cache-1v0mbdj, [data-testid="stHeader"], [data-testid="stFooter"], [data-testid="stStatusWidget"], .viewerBadge_container__1QSob {{ display: none !important; }}
